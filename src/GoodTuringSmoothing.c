 ...
 * @param data Data used to calculate ngram probabilities.
 */
 ...
 * @param counts_of_counts Counts of counts. countsOfCounts[1] is the number of words occurred once in the corpus.
